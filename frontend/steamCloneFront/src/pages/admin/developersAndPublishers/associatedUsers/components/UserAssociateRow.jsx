...
import { useRemoveAssociatedUserMutation } from "../../../../../services/developerAndPublisher/developerAndPublisherApi";
...
const UserAssociateRow = ({ user }) => {
  ...
  const handleDelete = async () => {
    try {
      await removeUser({ developerAndPublisherId: devpubId, userId: user.id }).unwrap();
