...
const MyGameCreate = () => {
  ...
  const {
    ...
    refetch: refetchDevelopersAndPublishers,
  } = useByAssociatedUserQuery(true);

  useEffect(() => {
    refetchDevelopersAndPublishers();
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(`/manager/my-games/edit/${created.id}`);
    } catch (err) {
