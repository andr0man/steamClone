...
namespace SteamClone.DAL.Migrations
{
    ...
    [Migration("20250708120024_AddedDeveloperAndPublisher")]
    partial class AddedDeveloperAndPublisher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SteamClone.Domain.Models.Developers.Developer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_developers_country_id");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_developers_created_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_developers_modified_by");
            ...
            modelBuilder.Entity("SteamClone.Domain.Models.Publishers.Publisher", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("CountryId")
                        .HasDatabaseName("ix_publishers_country_id");

                    b.HasIndex("CreatedBy")
                        .HasDatabaseName("ix_publishers_created_by");

                    b.HasIndex("ModifiedBy")
                        .HasDatabaseName("ix_publishers_modified_by");
            ...
            modelBuilder.Entity("SteamClone.Domain.Models.Developers.Developer", b =>
                {
                    b.HasOne("SteamClone.Domain.Models.Countries.Country", "Country")
                        ...
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_developers_countries_country_id");

                    b.HasOne("SteamClone.Domain.Models.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_developers_users_created_by");

                    b.HasOne("SteamClone.Domain.Models.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_developers_users_modified_by");
            ...
            modelBuilder.Entity("SteamClone.Domain.Models.Games.Game", b =>
                {
                    ...
                    b.HasOne("SteamClone.Domain.Models.Developers.Developer", "Developer")
                        .WithMany()
                        .HasForeignKey("DeveloperId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_games_developers_developer_id");
                    ...
                    b.HasOne("SteamClone.Domain.Models.Publishers.Publisher", "Publisher")
                        .WithMany()
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_games_publishers_publisher_id");
            ...
            modelBuilder.Entity("SteamClone.Domain.Models.Publishers.Publisher", b =>
                {
                    b.HasOne("SteamClone.Domain.Models.Countries.Country", "Country")
                        ...
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_publishers_countries_country_id");

                    b.HasOne("SteamClone.Domain.Models.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_publishers_users_created_by");

                    b.HasOne("SteamClone.Domain.Models.Auth.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedBy")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_publishers_users_modified_by");
