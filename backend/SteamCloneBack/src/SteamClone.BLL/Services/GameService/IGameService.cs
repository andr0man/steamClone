...
{
    Task<ServiceResponse> AddSystemRequirementsAsync(string gameId, SystemReqCreateUpdateVM model,
        CancellationToken cancellationToken);

    Task<ServiceResponse> DeleteSystemRequirementsAsync(string gameId, string systemRequirementId,
        CancellationToken cancellationToken);
